...
\url{https://r-forge.r-project.org/R/?group_id=1743}
...
Course overview and pdf's are available + Excercise. \\
\medskip

\emph{
 Excercise needs to be handed in before 1030 the day after the lesson so that we can provide feedback on the excercise and discuss shortly.
}
...
\emph{Submit a documented script to}
\emph{Using data with the 'rasta' package}
Submit your code? 
