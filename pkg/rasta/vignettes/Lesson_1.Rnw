...
\textbf{How do you write your function if you want to return x and z?}
...
\item{the next slide contains an example script which you can use as a template for creating your function}
\end{itemize}

\medskip
\emph{This will be a test to see if your R scripting levels are ok to continue the course in the coming months.}
...
Here is an example of how you can create a map in R. Try it out and use this as a template for creating a function.
<<>>=
