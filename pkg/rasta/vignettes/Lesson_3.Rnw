...
This sections describes the structure of a simple package, for more information about R packages in general and details of package creation, please refer to the manual (\dots). 
...
The \code{package.skeleton} function will help you get the package structure from a list of sourced functions.
