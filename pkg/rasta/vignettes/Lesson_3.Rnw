...
<<raster-1, echo=FALSE, fig=TRUE, include=FALSE>>=
plot(r)
@

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{Lesson_3-raster-1}
...
<<cars, echo=FALSE, fig=TRUE, include=FALSE>>=
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{Lesson_3-cars}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{Lesson_3-meuse1}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{Lesson_3-meuse2}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{Lesson_3-minus}
