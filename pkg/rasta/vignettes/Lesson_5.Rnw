...
TODO(): Find a way to compare the values of these rasters... That could be the exercise.; write a function that checks that 2 rasterLayers are identical...
...
# It does not matter which of ndvi, ndvi2, or ndvi3 we choose
