...
%% can we set nice colours to the R code sections?
...
% ## f <- system.file("extdata/kenpop89to99.csv", package="rasta") % does not work while running Latex to compile the file

<<readcsvexample>>=
#--------------------------READING DATA IN AND OUT------------------------------
mydat<-read.csv("data/kenpop89to99.csv") 
@
